% Bivariate CClayton copula cumulative distribution function (cdf)
% (uniform marginals)
%
%SYNOPSYS
%   C = BICCLAY_COPULACDF(u, theta)
%
%INPUT
...
function C = bicclay_copulacdf(u, theta)
...
C = u1 + u2 -1 + ((1-u1).^-theta + (1-u2).^-theta -1).^-(1/theta);
