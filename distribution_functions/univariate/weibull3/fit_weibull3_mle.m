% FIT_WEIBULL3_MLE Three-parameter weibull maximum likelihood parameter estimation
% using GEV parametrization with constrain on shape parameter (< 0)
%
%SYNOPSYS
% [parmhat, max_nLL, output] = FIT_WEIBULLM3_MLE(data)
%
%INPUT
% data      sample vector
%
...
function [parmhat, max_nLL, output] = fit_weibull3_mle(data)
...
loc_ub = (max(data) - mom_par(2)/-mom_par(1))*1.1;
